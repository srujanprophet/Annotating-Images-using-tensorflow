...
def resize(image, new_width=None, new_height=None):
	"""
	Resize an image based on a new width or new_height
...
class webcamStream:
	def __init__(self):
		...
		# Start capturing video on the Webcam, will tune itself
...
if __name__ == '__main__':
	...
	while True:
		...
		frame = resize(stream.get(), new_width=600)
		cv2.imshow("webcam",frame)
		# If the spacebar is hit, the program will stop
